...
const ChatPage = () => {
  ...
  return (
    <div
      className="h-[93vh] w-full overflow-hidden bg-base-100 text-base-content" // This syncs with theme
      data-theme={theme} // Optional if Layout or App already handles theme
    >
